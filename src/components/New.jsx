...
//                     <div className="w-[50%]">
//                         <h1 className="text-3xl px-4 font-medium lg:text-4xl lg:font-bold">New </h1>
//                     </div>
...
//                     <div className="h-[250px] p-2 shadow-sm rounded-lg">
//                         <div className="w-full h-[70%] bg-white rounded-lg overflow-hidden">
//                             <img src="public/house/home1.png" alt="" className="w-full h-full object-cover" />
//                         </div>
//                         <div className="w-full p-[2px] rounded-lg my-1 border-2 border-blue-400 flex space-x-1">
//                             <div className="w-[40px] h-[40px] overflow-hidden bg-black rounded-lg">
//                                 <img src="public/house/home1.png" alt="" className="w-full h-full object-cover" />
//                             </div>
//                             <div className="w-[40px] h-[40px] overflow-hidden bg-black rounded-lg">
//                                 <img src="public/house/home3.png" alt="" className="w-full h-full object-cover" />
//                             </div>
//                             <div className="w-[40px] h-[40px] overflow-hidden bg-black rounded-lg">
...
//                      <div className="h-[250px] p-2 shadow-sm rounded-lg">
//                         <div className="w-full h-[70%] bg-white rounded-lg overflow-hidden">
//                             <img src="public/house/home2.png" alt="" className="w-full h-full object-cover" />
//                         </div>
//                         <div className="w-full p-[2px] rounded-lg my-1 border-2 border-blue-400 flex space-x-1">
//                             <div className="w-[40px] h-[40px] overflow-hidden bg-black rounded-lg">
